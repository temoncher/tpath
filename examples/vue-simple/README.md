...
- [`src/App.vue`](./src/App.vue) contains the translator factory, nested lookup, and notes UI.
- [`src/translations/`](./src/translations/) contains the nested dictionaries.
- [`src/main.ts`](./src/main.ts) binds the browser messages.
- [`src/App.test.ts`](./src/App.test.ts) verifies translation, interpolation, and debug behavior.
